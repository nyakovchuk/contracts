...
const file_account_service_proto_rawDesc = "" +
	...
	"\auser_id\x18\x01 \x01(\x04R\x06userId2\x93\x04\n" +
	"\aAccount\x12l\n" +
	"\n" +
...
var file_account_service_proto_goTypes = []any{
	...
	(*DeleteUserRequest)(nil),  // 7: account.DeleteUserRequest
...
var file_account_service_proto_depIdxs = []int32{
	...
	7,  // 11: account.Account.DeleteUser:input_type -> account.DeleteUserRequest
	...
	11, // 16: account.Account.DeleteUser:output_type -> google.protobuf.Empty
