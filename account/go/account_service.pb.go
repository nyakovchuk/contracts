...
const file_account_service_proto_rawDesc = "" +
	"\n" +
	"\x15account_service.proto\x12\aaccount\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x13account_model.proto\x1a\x1bpagination/pagination.proto\"<\n" +
	...
	"\auser_id\x18\x01 \x01(\x04R\x06userId2\x8e\x04\n" +
	"\aAccount\x12g\n" +
	"\n" +
	...
	"\n" +
	"UpdateUser\x12\x1a.account.UpdateUserRequest\x1a\x16.google.protobuf.Empty\")\x82\xd3\xe4\x93\x02#:\x01*\x1a\x1eaccount/api/v1/users/{user_id}\x12h\n" +
	"\n" +
	"DeleteUser\x12\x1a.account.DeleteUserRequest\x1a\x16.google.protobuf.Empty\"&\x82\xd3\xe4\x93\x02 *\x1eaccount/api/v1/users/{user_id}B4Z2github.com/nyakovchuk/contracts/account/go;accountb\x06proto3"
...
var file_account_service_proto_depIdxs = []int32{
	...
	5,  // 9: account.Account.UpdateUser:input_type -> account.UpdateUserRequest
	...
	10, // 14: account.Account.UpdateUser:output_type -> google.protobuf.Empty
	10, // 15: account.Account.DeleteUser:output_type -> google.protobuf.Empty
