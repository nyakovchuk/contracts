...
const file_auth_service_proto_rawDesc = "" +
	...
	"\rrefresh_token\x18\x02 \x01(\tR\frefreshToken2\x99\x02\n" +
	"\x04Auth\x129\n" +
...
var file_auth_service_proto_depIdxs = []int32{
	...
	2, // 2: auth.Auth.RefreshToken:input_type -> auth.RefreshRequest
	...
	5, // 7: auth.Auth.RefreshToken:output_type -> auth.TokenPair
